...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ELKABOOOS/SO_ROOOGEEN/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1829540452,1654178416,1720330493}   
...
os.execute('wget https://raw.githubusercontent.com/ELKABOOOS/SO_ROOOGEEN/main/DRAGON.lua')
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'T ＷＡＳＯＬ', url="t.me/G_W_P_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard.inline_keyboard = {
{{text = '𝚍𝚎𝚟 𝚎𝚕𝚔𝚊𝚋𝚘𝚘𝚜',url="t.me/G_W_P"}},
{{text = '𝚝𝚠𝚊𝚜𝚘𝚘𝚕',url="t.me/G_W_P_BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
مبرمج سورس روجين لو حابب تتوصل معاه
اتبع الزر إلى تحت ☆
...
if text == 'مارتن' or text == 'marten' or text == 'مارتن التونز' then
local Text = [[
مطور سورس روجين لو حابب تتوصل معاه
اتبع الزر إلى تحت ☆
...
if text == 'كريم' or text == 'كريم الماجيك' or text == 'مرات الكابوس' then
local Text = [[
ملك سورس روجين لو حابب تتوصل معاه
اتبع الزر إلى تحت ☆
...
if text == 'ملك السورس' then
local Text = [[ 
[ملك سورس روجين ☆](t.me/M_A_G_K)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚍𝚎𝚟 𝚊𝚕𝚖𝚊𝚐𝚔', url="t.me/I_C_X"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ELKABOOOS/SO_ROOOGEEN/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ELKABOOOS/SO_ROOOGEEN/main/File_Bot/"..file)
if res == 200 then
